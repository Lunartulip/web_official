  ...
  "@graph": [
    {
      ...
      knowsAbout: [
        ...
        "AI technology value-chain research",
        "machine-readable thematic research data",
      ...
      makesOffer: [
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Lunartulip Research Desk",
            alternateName: "Always-On Research Desk",
            serviceType: "Always-on thematic investment intelligence for AI technology",
            description: "Continuously maintained investment-relevant evidence, thesis states and signals across focused AI technology themes, delivered through institutional research subscriptions.",
